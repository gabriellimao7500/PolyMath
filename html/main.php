...
<head>
    ...
    <script defer src="../js/complete.js"></script>
    <script defer src="../js/lessons/lessons.js"></script>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-locate">
            ...
            <div class="sidebar-profile" id="perfil">
                <div class="sidebar-square">
    ...
    <div class="modules">
        ...
        <div class="module-one">
            ...
            <div class="module One" id="One">
                <h1>Módulo 1: nome do estudo</h1>
                <div class="lessons">
                    <div class="lesson A1">
                        <div class="learn-img icon1"></div>
                        <div class="learn-desc"><h4>Nome da aula</h4><h5>Descrição da aula</h5></div>
                    </div>
                    <div class="lesson A2">
