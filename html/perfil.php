    ...
    <div id="principal">
        <div class="sidebar">
            ...
            <div class="sidebar-locate">
                ...
                <div class="sidebar-friends" id="ranking">
                    <div class="sidebar-square">
        ...
        <div class="perfil-main">
            <div class="perfil">
                <div class="about-user">
                    <img src="../imgs/user-img.png" alt="" width="200px">
                    <h1 class="name-user">Mavine script user</h1>
                </div>

                <div class="XP">00000<span>XP</span></div>

                <div class="fase-user">

                    <div class="module-one-user">
                        <h1>Modulo 1</h1>
                        <div class="fases-complet-user">
                            <img src="../imgs/Learn.jpeg" alt="" width="45px" height="45px" id="fases-complet-user-img">
                            <h2 id="name-lesson-user">Nome da aula <br><span id="descricao-user">Descricao da aula</span></h2>
                        </div>
                        <div class="fases-complet-user">
                            <img src="../imgs/Lock.jpeg" alt="" width="45px" height="45px" id="fases-complet-user-img">
                            <h2 id="name-lesson-user">Nome da aula <br><span id="descricao-user">Descricao da aula</span></h2>
                        </div>
                        <div class="fases-complet-user">
                            <img src="../imgs/Lock.jpeg" alt="" width="45px" height="45px" id="fases-complet-user-img">
